# SynDEc: A Synthetic Data Sharing Ecosystem (Online Appendix)

The following repository contains the online appendix for the paper [SynDEc: A Synthetic Data Sharing Ecosystem](https://link.springer.com/article/10.1007/s12525-024-00746-8). It not only provides the Python code for all experiments conducted in the different design cycles but also the background for literature reviews and interviews. Below you will find the overall structure of the research project:
