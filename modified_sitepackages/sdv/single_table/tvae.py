...
from ..errors import InvalidDataTypeError, NotFittedError
from .base import BaseSingleTableSynthesizer
from .utils import detect_discrete_columns
...
class TVAE(BaseSynthesizer):
    ...
    def refit(self, train_data, epochs, discrete_columns=(), max_clusters= 10):
        """Fit the TVAE Synthesizer models to the training data.
...
class TVAESynthesizer(LossValuesMixin, BaseSingleTableSynthesizer):
    ...
    def _refit(self, processed_data):
        """Fit the model to the table.
        ...
        self._model.refit(processed_data, discrete_columns=discrete_columns, epochs= self.epochs)
