...
class BaseSynthesizer:
    ...
    def preprocess(self, data, refit= False):
    ...
    def fit_processed_data(self, processed_data, refit= False):
    ...
    def refit(self, data, epochs):
        ...
        check_synthesizer_version(self, is_fit_method=True, compare_operator=operator.lt)
        self._check_metadata_updated()
        processed_data = self.preprocess(data, refit= True)
        self.fit_processed_data(processed_data, refit= True)
